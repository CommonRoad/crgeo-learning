...
from crgeo.common.utils.filesystem import save_dill
from crgeo.common.utils.system import get_gpu_count, get_gpu_usage
from crgeo.dataset.commonroad_dataset import T_Data
from crgeo_learning.geometric.base_geometric import BaseGeometric, MODEL_FILE
from crgeo_learning.geometric.training.callbacks.base_callback import CheckpointCallbackParams, EarlyStoppingCallbacksParams, InitializeTrainingCallbacksParams, \
    InterruptCallbacksParams, LoggingCallbacksParams, StepCallbackParams
from crgeo_learning.geometric.training.callbacks.callback_computer_container_service import CallbackComputerContainerService, CallbackComputersContainer
from crgeo_learning.geometric.training.callbacks.implementations.early_stopping_callback import EarlyStoppingCallback
from crgeo_learning.geometric.training.callbacks.implementations.epoch_checkpoint_callback import EpochCheckpointCallback
from crgeo_learning.geometric.training.callbacks.implementations.export_latest_model_callback import ExportLatestModelCallback
from crgeo_learning.geometric.training.callbacks.implementations.gradient_clipping_callback import GradientClippingCallback
from crgeo_learning.geometric.training.callbacks.implementations.log_wandb_callback import LogWandbCallback
from crgeo_learning.geometric.training.callbacks.implementations.watch_model_callback import WatchWandbCallback
from crgeo_learning.geometric.training.render_model import PYTHON_PATH_RENDER_MODEL, render_model
from crgeo_learning.geometric.training.training_utils import DebugCallback, custom_collate_fn
from crgeo_learning.geometric.training.types import GeometricTrainingContext, GeometricTrainingResults
from crgeo_learning.geometric.types import Train_Categories, Train_Features
from crgeo_learning.training.optimizer.hyperparameter_optimizer_service import BaseOptimizerService
    ...
    def load_dataset_and_setup_trainer(
        ...
        if optimizer_service is not None:
            ...
            if self._cfg.overfit:
                ...
                dataset_validation, dataset_train = dataset.split(size=self._cfg.validation_split)
