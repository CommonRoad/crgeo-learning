...
from crgeo.common.utils.filesystem import get_most_recent_file, list_files
from crgeo.common.utils.seeding import set_system_time_seed
from crgeo_learning.reinforcement.commonroad_gym_env import CommonRoadGymStepInfo
from crgeo_learning.reinforcement.constants import COMMONROAD_GYM_ENV_ID
...
def render_agent(
    ...
    if video_folder is not None:
        ...
        venv = VecVideoRecorder(
            RecordVideo(env, video_folder + "/gym-results"),
