...
from crgeo_learning.reinforcement.observer.base_observer import BaseObserver, T_Observation
...
class FlattenedGraphObserver(BaseObserver):
    ...
    def setup(self, dummy_data: CommonRoadData) -> gym.spaces.Space:
        observation_space_dict: OrderedDict[str, gym.spaces.Box] = OrderedDict()
        ...
        for k, v in flattened_data.items():
            ...
            observation_space_dict[k] = gym.spaces.Box(
