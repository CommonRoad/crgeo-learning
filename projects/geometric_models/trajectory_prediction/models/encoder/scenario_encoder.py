...
class ScenarioEncoderModel(nn.Module):
    ...
    def forward(self, data: Union[CommonRoadData, CommonRoadDataTemporal]) -> Tensor:
        ...
        x_dict = {
            "lanelet": x_lanelet,
            "vehicle": x_vehicle #self.batch_norm_v(x_vehicle)
        }
        ...
        edge_attr_dict = {
            ('vehicle', 'to', 'vehicle'): edge_attr_v2v, #self.batch_norm_v2v(edge_attr_v2v),
            ('lanelet', 'to', 'lanelet'): edge_attr_lanelet,
            ('vehicle', 'to', 'lanelet'): edge_attr_v2l, #self.batch_norm_v2l(edge_attr_v2l),
