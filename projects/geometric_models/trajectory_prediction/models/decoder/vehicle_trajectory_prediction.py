...
from crgeo_learning.geometric.base_geometric import BaseModel
    ...
    def compute_loss(
        ...
        if self.training:
            for i, vehicle_states in enumerate(prediction):
                ...
                loss_sum = loss_sum + loss["primary_weighted"]
            ...
            for i, vehicle_states in enumerate(prediction):
                ...
                if i==len(prediction)-1:
                    final_loss = loss["primary"]
            average_displacement_error = loss_sum / len(prediction)
            return average_displacement_error, {'final_displacement_error' : final_loss,
